...
```
  /**
    ...
    */
   function createProject(string memory name, string memory description, uint256 price) public returns (bool) {
...
```
 /**
    ...
    */
   function donateToProject(uint256 _bookId, uint256 startTime, uint256 endTime) public payable returns(bool) {
